import { faBoxOpen, faChevronLeft, faFingerprint, faMagnifyingGlass, faMemory, faTerminal, faStairs} from '@fortawesome/free-solid-svg-icons';
...
function App() {
        const [progressArray, setProgressArray] = useState([false, false, false, false, false, false]);
        ...
        useEffect(() => {
            ...
            if (allLevelsCompleted && !rowsMoved) {
                setRowsMoved(true); 
                //do a reveal for the end of the scavenger hunt
            }
        ...
        const updateProgress = (levelCompleted, completeAll = false) => {
            ...
            const renderCurrentLevel = () => {
                ...
                switch (viewedChallenge) {
                    ...
                    case 6:
                        return <Level6 progressToNextLevel={() => updateProgress(6)} />;
                    default:
                ...
                return (
                    <div className={`challenge-container ${rowsMoved ? "rows-moved" : ""} ${videoReveal ? "video-reveal" : ""}`}>
                        ...
                        <div className="challenge-row bottom-row">
                            ...
                            <div className={`challenge-item ${progressArray[5] ? "completed" : ""}`} id="challenge6" onClick={() => setViewedChallenge(6)}>
                                <FontAwesomeIcon icon={faStairs} size="3x" className="icon" />
                            </div>
                        </div>
                    </div>
                );
